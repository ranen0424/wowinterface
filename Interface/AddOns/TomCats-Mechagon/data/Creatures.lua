	...
	{ "Creature ID", "Vignette ID", "Alliance React", "Horde React", "Level", "Locations", "Alliance Tracking ID", "Horde Tracking ID", "World Quest ID", "Bonus Roll Tracking ID", "Loot", },
		{
			...
			{ 151308, 3583, -1, -1, 120, {{0.538, 0.312 }, { 0.538, 0.312 }}, 55539, 55539, nil, nil, { items = {168908,} }, }, -- Boggac Skullbash
			{ 153200, 3633, -1, -1, 120, {{0.513, 0.503 }, { 0.513, 0.503 }}, 55857, 55857, nil, nil, { items = {167042,168908,} }, }, -- Boilburn
			...
			{ 150342, 3634, -1, -1, 120, {{0.63, 0.256 }, { 0.63, 0.256 }}, 55814, 55814, nil, nil, { items = {167042,168908,} }, }, -- Earthbreaker Gulroc
			...
			{ 153205, 3631, -1, -1, 120, {{0.596, 0.673 }, { 0.596, 0.673 }}, 55855, 55855, nil, nil, { items = {168908,} }, }, -- Gemicide
			...
			{ 151124, 3546, -1, -1, 120, {{0.57, 0.52 }, { 0.57, 0.52 }}, 55207, 55207, nil, nil, { items = {168490,168908,} }, }, -- Mechagonian Nullifier
			...
			{ 153206, 3629, -1, -1, 120, {{0.56, 0.367 }, { 0.56, 0.367 }}, 55853, 55853, nil, nil, { items = {167846,168908,} }, }, -- Ol' Big Tusk
			...
			{ 153226, 3630, -1, -1, 120, {{0.2507, 0.7734 }, { 0.2507, 0.7734 }}, 55854, 55854, nil, nil, { items = {168062,168908,} }, }, -- Steel Singer Freza
			{ 155060, 155060, -1, -1, 120, {{0.8095, 0.2017 }, { 0.8095, 0.2017 }}, 56419, 56419, nil, nil, { }, }, -- The Doppel Gang
			{ 152113, 3635, -1, -1, 120, {{0.684, 0.482 }, { 0.684, 0.482 }}, 55858, 55858, nil, nil, { items = {169886,168908,} }, }, -- The Kleptoboss
