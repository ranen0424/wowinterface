local DataVersion = 2
local LibItemData, oldminor = LibStub:NewLibrary("LibItemData-1.1", DataVersion)

if not LibItemData then return end
LibItemData.data = HuanhuaItemData
...
function LibItemData:FindItem(itemID)
