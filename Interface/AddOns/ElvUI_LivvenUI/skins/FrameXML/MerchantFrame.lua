...
local function styleMerchant()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.merchant ~= true or E.private.lui.luiSkins.blizzard.merchant ~= true then return end
	...
	for i = 1, _G.BUYBACK_ITEMS_PER_PAGE do
		...
		for j = 1, 3 do
			LS:CreateBG(_G["MerchantItem"..i.."AltCurrencyFrameItem"..j.."Texture"])
...
S:AddCallback("LuiMerchant", styleMerchant)
