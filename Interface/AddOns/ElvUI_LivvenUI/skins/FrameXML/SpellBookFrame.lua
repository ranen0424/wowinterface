...
local function styleSpellBook()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.spellbook ~= true or E.private.lui.luiSkins.blizzard.spellbook ~= true then return end
	...
	for _, button in pairs(professions) do
		...
		LS:CreateBDFrame(bu.statusBar, .25)
	end
...
S:AddCallback("LuiSpellbook", styleSpellBook)
