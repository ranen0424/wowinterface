...
local function styleMinimap()
	if E.private.skins.blizzard.enable ~= true or E.private.lui.luiSkins.blizzard.minimap ~= true or E.private.general.minimap.enable ~= true then return end
...
S:AddCallback("LuiSkinMinimap", styleMinimap)
