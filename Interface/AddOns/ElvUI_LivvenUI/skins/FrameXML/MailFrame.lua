...
local function styleMail()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.mail ~= true or E.private.lui.luiSkins.blizzard.mail ~= true then return end

	local MiniMapMailFrame = _G.MiniMapMailFrame

	-- Change the Minimap Mail icon
	_G.MiniMapMailIcon:SetTexture("Interface\\AddOns\\ElvUI_LivvenUI\\media\\textures\\Mail")
	...
	MiniMapMailFrame:SetScript("OnShow", function()
		if not MiniMapMailFrame.highlight then
			...
			MiniMapMailFrame.highlight.tex:SetTexture("Interface\\AddOns\\ElvUI_LivvenUI\\media\\textures\\Mail")
			...
			LUI:CreatePulse(MiniMapMailFrame, 1, 1)
		end
	end)
...
S:AddCallback("LuiMail", styleMail)
