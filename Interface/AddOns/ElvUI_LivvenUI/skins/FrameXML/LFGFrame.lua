...
local function styleLFG()
	...
	local function styleRewardButton(button)
		...
		LS:CreateBD(button.bg2, .25)
		LS:CreateGradient(button.bg2)
	end
	...
	local leaderBg = LS:CreateBG(_G.LFGDungeonReadyDialogRoleIconLeaderIcon)
	...
	do
		local bg = LS:CreateBDFrame(_G.LFGDungeonReadyDialogRoleIcon, 1)
