...
local function styleTalents()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.talent ~= true or E.private.lui.luiSkins.blizzard.talent ~= true then return end
...
S:AddCallbackForAddon("Blizzard_TalentUI", "LuiTalents", styleTalents)
