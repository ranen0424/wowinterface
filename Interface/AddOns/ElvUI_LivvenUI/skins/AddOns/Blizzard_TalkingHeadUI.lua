...
local function styleTalkingHead()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.talkinghead ~= true or E.private.lui.luiSkins.blizzard.talkinghead ~= true then return end
	...
	TalkingHeadFrame.BackgroundFrame.TextBackground.SetAtlas = LUI.dummy
	TalkingHeadFrame.PortraitFrame.Portrait.SetAtlas = LUI.dummy
	TalkingHeadFrame.MainFrame.Model.PortraitBg.SetAtlas = LUI.dummy
	...
	TalkingHeadFrame.NameFrame.Name.SetTextColor = LUI.dummy
	...
	TalkingHeadFrame.TextFrame.Text.SetTextColor = LUI.dummy
	TalkingHeadFrame.TextFrame.Text:SetShadowColor(0, 0, 0, 1)
	TalkingHeadFrame.TextFrame.Text:SetShadowOffset(2, -2)
end

S:AddCallbackForAddon("Blizzard_TalkingHeadUI", "LuiTalkingHead", styleTalkingHead)
