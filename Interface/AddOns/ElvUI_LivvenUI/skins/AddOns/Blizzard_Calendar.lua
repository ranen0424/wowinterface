...
local function styleCalendar()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.calendar ~= true or E.private.lui.luiSkins.blizzard.calendar ~= true then return end
...
S:AddCallbackForAddon("Blizzard_Calendar", "LuiCalendar", styleCalendar)
