...
local function styleDebugTools()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.debug ~= true or E.private.lui.luiSkins.blizzard.debug ~= true then return end
...
S:AddCallbackForAddon("Blizzard_DebugTools", "LuiDebugTools", styleDebugTools)
