...
local function styleGuild()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.guild ~= true or E.private.lui.luiSkins.blizzard.guild ~= true then return end
...
S:AddCallbackForAddon("Blizzard_GuildUI", "LuiGuild", styleGuild)
