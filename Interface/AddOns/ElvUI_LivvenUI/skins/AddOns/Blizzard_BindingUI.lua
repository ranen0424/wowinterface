...
local function styleBinding()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.binding ~= true or E.private.lui.luiSkins.blizzard.binding ~= true then return end
...
S:AddCallbackForAddon("Blizzard_BindingUI", "LuiBinding", styleBinding)
