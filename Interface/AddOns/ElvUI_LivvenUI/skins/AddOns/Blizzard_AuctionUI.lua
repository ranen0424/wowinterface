...
local function styleAuctionhouse()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.auctionhouse ~= true or E.private.lui.luiSkins.blizzard.auctionhouse ~= true then return end
...
S:AddCallbackForAddon("Blizzard_AuctionUI", "LuiAuctionhouse", styleAuctionhouse)
