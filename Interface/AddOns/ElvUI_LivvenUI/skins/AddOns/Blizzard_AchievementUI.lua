...
local function styleAchievement()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.achievement ~= true or E.private.lui.luiSkins.blizzard.achievement ~= true then return end
	...
	hooksecurefunc("AchievementFrameSummary_UpdateAchievements", function()
		for i = 1, ACHIEVEMENTUI_MAX_SUMMARY_ACHIEVEMENTS do
			...
			if not bu.reskinned then
				...
				text.SetTextColor = LUI.dummy
				text:SetShadowOffset(1, -1)
				text.SetShadowOffset = LUI.dummy
...
S:AddCallbackForAddon("Blizzard_AchievementUI", "LuiAchievement", styleAchievement)
