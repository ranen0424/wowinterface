...
local function styleTrainer()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.trainer ~= true or E.private.lui.luiSkins.blizzard.trainer ~= true then return end
...
S:AddCallbackForAddon("Blizzard_TrainerUI", "LuiTrainer", styleTrainer)
