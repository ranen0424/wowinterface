...
local LibItemGem = LibStub:GetLibrary("LibItemGem-Lui")
local LibSchedule = LibStub:GetLibrary("LibSchedule-Lui")
local LibItemEnchant = LibStub:GetLibrary("LibItemEnchant-Lui")
...
local function CreateIconFrame(frame, index)
    ...
    icon.bg:SetTexture("Interface\\AddOns\\ElvUI_LivvenUI\\media\\textures\\GemBg")
...
function LI:LoadInspectUnitGemAndEnchant()
